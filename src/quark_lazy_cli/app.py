...
""")
    ...
    def _save_report(self, run_results):
        ...
        status_map = {"success": "成功", "no_update": "无更新", "no_candidate": "候选失效", "failed": "失败"}
        msg_map = {
    ...
    def _handle_update_command(
        ...
        try:
            ...
            try:
                ...
                status = "no_candidate" if res.get("no_candidate") else ("no_update" if res.get("no_update") else "success")
                run_results.append(
                    {
                        "taskname": task.get("taskname"),
                        "status": status,
